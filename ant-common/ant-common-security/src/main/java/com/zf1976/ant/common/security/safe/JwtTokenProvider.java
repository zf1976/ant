...
public class JwtTokenProvider {
    ...
    public static String createToken(Authentication authentication) {
        final SecurityUserDetails userDetails = (SecurityUserDetails) authentication.getDetails();
    ...
    public static Authentication resolveAuthentication(String token) {
        ...
        try {
            ...
            // 转为自定义异常 抛出处理
            throw new com.zf1976.ant.common.security.safe.exception.ExpiredJwtException(AuthenticationState.EXPIRED_JWT);
        }
