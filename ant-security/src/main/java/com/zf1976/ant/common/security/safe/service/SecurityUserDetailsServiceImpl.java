package com.zf1976.ant.common.security.safe.service;
...
import com.zf1976.ant.common.security.safe.exception.UserNotFountException;
...
public class SecurityUserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) {
        ...
        if (!userInfoVo.getEnabled()) {
            ...
            securityUserDetails = new SecurityUserDetails(userInfoVo,
