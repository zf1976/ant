...
import com.zf1976.ant.common.security.safe.exception.PasswordException;
import com.zf1976.ant.common.security.safe.exception.RsaDecryptException;
...
public class SecurityAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication){
        ...
        if (matchesPassword(rawPassword, encodePassword)) {
            final AuthenticationDetails credentials = (AuthenticationDetails) authentication.getDetails();
