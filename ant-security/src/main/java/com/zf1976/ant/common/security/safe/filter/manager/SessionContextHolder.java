...
public class SessionContextHolder {
    ...
    public static void set(String token, UserDetails userDetails, HttpServletRequest httpServletRequest) {
        SESSION_SERVICE.save(token, (SecurityUserDetails) userDetails, httpServletRequest);
    }
     ...
     */
    public static void refresh(String token, SecurityUserDetails userDetails, HttpServletRequest httpServletRequest) {
