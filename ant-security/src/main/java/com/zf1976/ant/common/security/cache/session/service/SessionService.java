...
public interface SessionService {
     ...
     * @param request     详情
     */
    void save(String token, SecurityUserDetails userDetails, HttpServletRequest request);
     ...
     * @param request     详情
     */
    void update(String token, SecurityUserDetails userDetails, HttpServletRequest request);
